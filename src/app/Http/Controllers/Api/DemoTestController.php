...
final class DemoTestController extends Controller
{
     ...
     */
    public function store(DemoTestRequest $request): JsonResponse
    {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function activate(DemoTestActivationRequest $request): JsonResponse
    {
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function deactivate(DemoTestActivationRequest $request): JsonResponse
    {
        $refs = $request->input('refs');
